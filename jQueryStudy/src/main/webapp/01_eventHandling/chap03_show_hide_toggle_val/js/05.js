$(document).ready(function(){
    ...
    }); // end of $("input:checkbox[name='answer']").click(function(){}
        ...
        /*
            ==== jQuery 에서 라디오 또는 체크박스에 선택을 했는지를 알아오는 2가지 방법 ====
             ...
             2. $(라디오 또는 체크박스의 선택자).is(":checked")   
                ==> 선택을 했으면 true, 선택을 안했으면 false
        */
            // console.log("체크박스 선택여부 => ", $(this).prop("checked"));
            // 또는
            // console.log("체크박스 선택여부 => ", $(this).is(":checked"));
        ...
        if(!is_choice) {    // 정답이든 오답이든 체크박스 선택을 아예 아무것도 하지 않은 경우
            alert("정답을 선택하세요.!!");
        }
    ...
    $("button#btnRestart").bind('click', function(){
        ...
        $("input:checkbox[name='answer']").prop("checked", false);
        // name이 answer인 모든 체크박스에 선택이 안되어지도록 만드는 것이다.
